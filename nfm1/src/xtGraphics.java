...
public class xtGraphics extends Panel
{
    ...
    int dested[];
    String names[] = {
        "Tornado Shark", "Formula 7", "Wow Caninaro", "La vite Crab", "Nimi", "MAX Revenge", "Lead Oxide", "EL KING", "Radical One", "DR Monstaa"
    };
    int dmcnt;
    boolean dmflk;
    int pwcnt;
    ...
    public void loadpak1(MediaTracker mediatracker, Toolkit toolkit)
    {
        try
        {
            File file = new File("/app/games/nfm1/graphics/images1.zipo");
    ...
    public void loadpak2(MediaTracker mediatracker, Toolkit toolkit)
    {
        try
        {
            File file = new File("/app/games/nfm1/graphics/images2.zipo");
            DataInputStream datainputstream = new DataInputStream(new FileInputStream(file));
            ZipInputStream zipinputstream = new ZipInputStream(datainputstream);
            for(ZipEntry zipentry = zipinputstream.getNextEntry(); zipentry != null; zipentry = zipinputstream.getNextEntry())
            {
    ...
    public void loadpak3(MediaTracker mediatracker, Toolkit toolkit)
    {
        try
        {
            File file = new File("/app/games/nfm1/graphics/images3.zipo");
            DataInputStream datainputstream = new DataInputStream(new FileInputStream(file));
            ZipInputStream zipinputstream = new ZipInputStream(datainputstream);
            for(ZipEntry zipentry = zipinputstream.getNextEntry(); zipentry != null; zipentry = zipinputstream.getNextEntry())
            {
    ...
    private Clip getSound(String s)
    {
        ...
        Clip clip = null;
        try {
            audioInputStream = AudioSystem.getAudioInputStream(new File("/app/games/nfm1/" + s));
    ...
    private Image getImage(String s) {
        Image image = null;
        try {
            image = ImageIO.read(new File("/app/games/nfm1/" + s));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return image;
    ...
    public void loadpak4(MediaTracker mediatracker, Toolkit toolkit)
    {
        try
        {
            File file = new File("/app/games/nfm1/graphics/images4.zipo");
            DataInputStream datainputstream = new DataInputStream(new FileInputStream(file));
            ZipInputStream zipinputstream = new ZipInputStream(datainputstream);
            for(ZipEntry zipentry = zipinputstream.getNextEntry(); zipentry != null; zipentry = zipinputstream.getNextEntry())
            {
