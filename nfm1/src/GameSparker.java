...
public class GameSparker extends Panel
    ...
    public int readcookie(String s) {
        int i = -1;
        try {
            BufferedReader br = new BufferedReader(new FileReader(new File("/files/nfm1/cookies/" + s)));
    ...
    public void loadbase(ContO aconto[], Medium medium, Trackers trackers) {
        ...
        try {
            File file = new File("/app/games/nfm1/graphics/models.zipo");
    ...
    public void loadstage(ContO aconto[], ContO aconto1[], Medium medium, Trackers trackers, CheckPoints checkpoints, xtGraphics xtgraphics, Madness amadness[],
        ...
        String s1 = "";
        try {
            File file = new File("/app/games/nfm1/stages/" + checkpoints.stage + ".txt");
            DataInputStream datainputstream = new DataInputStream(new FileInputStream(file));
            String s;
    ...
    public void savecookie(String s, String s1) {
        try {
            PrintWriter pw = new PrintWriter(new File("/files/nfm1/cookies/" + s));
            pw.println(s1);
            pw.flush();
            pw.close();
        } catch (Exception _ex) {
    ...
    public boolean cookieDir() {
        File f = new File("/files/nfm1/cookies");
    ...
    public boolean initKeySettings() {
        try {
            File file = new File("/files/nfm1/KeySettings.txt");
