...
public class xtGraphics extends Panel {
   ...
   public void loadpak1(MediaTracker mediatracker, Toolkit toolkit) {
      try {
         File file = new File("/app/games/nfm-mdx-v1/graphics/images1.zipo");
   ...
   public void credits(Graphics g, Control control) {
      ...
      if (this.flipo == 2) {
         ...
         this.drawcs(g, 160, "Tracks, Images, Cars and other stuff", 0, 0, 0, 3);
         this.drawcs(g, 180, "by André (MoGa_DeX) Lopes", 0, 0, 100, 3);
         this.drawcs(g, 220, "This version of the game was updated and is maintained", 0, 0, 0, 3);
         this.drawcs(g, 235, "By Jaroslav Paska (Phyrexian)", 0, 0, 100, 3);
         this.drawcs(g, 270, "Thank you to all the people who waited for this and supported me!", 150, 0, 0, 3);
         ...
         if (madness.trcnt == 10) {
            ...
            if (this.auscnt < 45) {
               ...
               if (!this.wasay) {
                  ...
                  if (madness.power != 98.0F) {
                     this.say = "Fuel Up " + (int)(100.0F * madness.powerup / 98.0F) + "%";
                  } else {
      ...
      if (this.winner) {
         if (checkpoints.stage == this.unlocked) {
            ...
            if (checkpoints.stage != 11) {
               ...
               if (this.aflk) {
                  this.drawcs(g, 150, "You're Awesome!", 144, 167, 255, 3);
               } else {
                  this.drawcs(g, 152, "You're Awesome!", 228, 240, 255, 3);
               }
               ...
               this.ftm = g.getFontMetrics();
               if (this.aflk) {
                  this.drawcs(g, 280, "Be sure to check aimgames.forummotion.com for more action!", 144, 167, 255, 3);
               } else {
                  this.drawcs(g, 280, "Be sure to check aimgames.forummotion.com for more action!", 208, 240, 255, 3);
               }
   ...
   public void loadpak2(MediaTracker mediatracker, Toolkit toolkit) {
      try {
         File file = new File("/app/games/nfm-mdx-v1/graphics/images2.zipo");
         DataInputStream datainputstream = new DataInputStream(new FileInputStream(file));
         ZipInputStream zipinputstream = new ZipInputStream(datainputstream);
   ...
   public void musicomp(int i, Graphics g, Control control) {
      ...
      if (i == 10) {
         if (this.aflk) {
            this.drawcs(g, 340, "> Figure out your own path... Cause the arrow wont help you!", 200, 0, 0, 3);
            this.aflk = false;
         } else {
            this.drawcs(g, 340, "> Figure out your own path... Cause the arrow wont help you!", 0, 0, 0, 3);
            this.aflk = true;
         }
      }
   ...
   public void loadpak3(MediaTracker mediatracker, Toolkit toolkit) {
      try {
         File file = new File("/app/games/nfm-mdx-v1/graphics/images3.zipo");
         DataInputStream datainputstream = new DataInputStream(new FileInputStream(file));
         ZipInputStream zipinputstream = new ZipInputStream(datainputstream);
   ...
   public void carselect(Control control, ContO[] aconto, Madness madness, Graphics g) {
      ...
      if (this.flipo == 0) {
         ...
         if ((this.sc[0] - 4) * 2 >= this.unlocked) {
            ...
            this.drawcs(g, 345, "Complete stage " + (this.sc[0] - 4) * 2 + " to unlock this car...", 160, 176, 255, 3);
         } else {
            g.setFont(new Font("SansSerif", 1, 11));
            this.ftm = g.getFontMetrics();
            ...
            g.drawString("Tank Capacity:", 290, 343);
   ...
   private Clip getSound(String s) {
      ...
      try {
         AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File("/app/games/nfm-mdx-v1/" + s));
   ...
   private Image getImage(String s) {
      ...
      try {
         image = ImageIO.read(new File("/app/games/nfm-mdx-v1/" + s));
      } catch (Exception var4) {
         var4.printStackTrace();
      }
   ...
   public void loadpak4(MediaTracker mediatracker, Toolkit toolkit) {
      try {
         File file = new File("/app/games/nfm-mdx-v1/graphics/images4.zipo");
         DataInputStream datainputstream = new DataInputStream(new FileInputStream(file));
         ZipInputStream zipinputstream = new ZipInputStream(datainputstream);
