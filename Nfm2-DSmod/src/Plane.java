      ...
      if (j == -15) {
         ...
         for (int k3 = 0; k3 < this.n; k3++) {
            if (Math.random() > Math.random()) {
               this.ox[k3] = this.ox[k3] + (int)(8.0 * Math.random() - 4.0);
            }

            if (Math.random() > Math.random()) {
               this.oy[k3] = this.oy[k3] + (int)(8.0 * Math.random() - 4.0);
            }

            if (Math.random() > Math.random()) {
               this.oz[k3] = this.oz[k3] + (int)(8.0 * Math.random() - 4.0);
            }
         }
      }
         ...
         do {
            if (l3 != j3) {
               this.deltaf = this.deltaf
                  * (float)(
                     Math.sqrt(
                           (this.ox[l3] - this.ox[j3]) * (this.ox[l3] - this.ox[j3])
                              + (this.oy[l3] - this.oy[j3]) * (this.oy[l3] - this.oy[j3])
                              + (this.oz[l3] - this.oz[j3]) * (this.oz[l3] - this.oz[j3])
                        )
                        / 100.0
                  );
            }
   ...
   public void d(Graphics g, int i, int j, int k, int l, int i1, int j1, int k1, int l1, boolean flag, int i2) {
      ...
      if (this.embos == 0) {
         ...
         if (this.embos <= 11 && this.m.random() > 0.5 && !this.glass) {
            for (int l2 = 0; l2 < this.n; l2++) {
               ...
               ai2[l2] = (int)(this.oy[l2] + j + (15.0F - this.m.random() * 30.0F));
               ai1[l2] = (int)(this.oz[l2] + k + (15.0F - this.m.random() * 30.0F));
            }
         ...
         if (this.embos >= 16) {
            ...
            int i7 = (int)(Math.abs(ai[0] - ai[1]) / 3 * (0.5 - this.m.random()));
            int l7 = (int)(Math.abs(ai1[0] - ai1[1]) / 3 * (0.5 - this.m.random()));
            ai[2] = (ai[0] + ai[1]) / 2 + i7;
            ai1[2] = (ai1[0] + ai1[1]) / 2 + l7;
            int i8 = (int)((Math.abs(ai[0] - ai[1]) + Math.abs(ai1[0] - ai1[1])) / 1.5 * (this.m.random() / 2.0F + 0.5));
            ...
            k8 = (int)(255.0F + 255.0F * (this.m.snap[0] / 400.0F));
            if (k8 > 255) {
               k8 = 255;
            }
            ...
            int i9 = (int)(169.0F + 169.0F * (this.m.snap[1] / 300.0F));
            if (i9 > 255) {
               i9 = 255;
            }
            ...
            int k9 = (int)(89.0F + 89.0F * (this.m.snap[2] / 200.0F));
            if (k9 > 255) {
               k9 = 255;
            }
            ...
            i9 = (int)(207.0F + 207.0F * (this.m.snap[1] / 300.0F));
            if (i9 > 255) {
               i9 = 255;
            }
            ...
            k9 = (int)(136.0F + 136.0F * (this.m.snap[2] / 200.0F));
            if (k9 > 255) {
               k9 = 255;
            }
         ...
         for (int k3 = 0; k3 < this.n; k3++) {
            if (this.typ == 1) {
               ai[k3] = (int)(this.ox[k3] * f + i);
            } else {
               ai[k3] = this.ox[k3] + i;
            }

            if (this.typ == 2) {
               ai2[k3] = (int)(this.oy[k3] * f + j);
            } else {
               ai2[k3] = this.oy[k3] + j;
            }

            if (this.typ == 3) {
               ai1[k3] = (int)(this.oz[k3] * f + k);
            } else {
               ai1[k3] = this.oz[k3] + k;
            }
         }
      ...
      if (this.chip != 0) {
         if (this.chip == 1) {
            ...
            this.cxy = i1;
            this.czy = j1;
            int i3 = (int)(this.m.random() * this.n);
      ...
      if (i1 != 0 || j1 != 0 || l != 0) {
         ...
         do {
            ...
            do {
               if (l3 != j3) {
                  this.projf = this.projf * (float)(Math.sqrt((ai[j3] - ai[l3]) * (ai[j3] - ai[l3]) + (ai1[j3] - ai1[l3]) * (ai1[j3] - ai1[l3])) / 100.0);
               }
            } while (++l3 < 3);
         } while (++j3 < 3);
      ...
      if (flag2) {
         ...
         if (!flag) {
            if (this.flx == 0) {
               ...
               g.setColor(new Color((int)var104, (int)var110, (int)var115));
               ...
               if (this.flx == 1) {
                  ...
                  g.setColor(new Color(var105, j13, k14));
                  g.drawPolygon(ai14, ai15, this.n);
                  this.flx = 2;
               }
               ...
               if (this.flx == 3) {
                  ...
                  g.setColor(new Color(var106, j13, k14));
                  g.drawPolygon(ai14, ai15, this.n);
                  this.flx = 2;
               }
            }
         ...
         if (this.gr == -18 && !this.m.trk) {
            ...
            if (this.m.cpflik && this.m.elecr >= 0.0F) {
               ...
               i14 = (int)(128.0F + 12.8F * this.m.elecr);
               if (i14 > 255) {
                  i14 = 255;
               }
   ...
   public void s(Graphics g, int i, int j, int k, int l, int i1, int j1, int k1) {
      ...
      if (k1 == 0) {
         ...
         for (int l6 = this.t.nt - 1; l6 >= 0; l6--) {
            int k7 = 0;
            if (Math.abs(this.t.zy[l6]) != 90
               && Math.abs(this.t.xy[l6]) != 90
               && Math.abs(i5 - (this.t.x[l6] - this.m.x)) < this.t.radx[l6]
               && Math.abs(i6 - (this.t.z[l6] - this.m.z)) < this.t.radz[l6]) {
               k7++;
            }
               ...
               for (int j8 = 0; j8 < this.n; j8++) {
                  ...
                  if (this.t.zy[l6] != 0) {
                     ai2[j8] = (int)(
                        ai2[j8]
                           + (
                              (ai1[j8] - (this.t.z[l6] - this.m.z - this.t.radz[l6])) * this.m.sin(this.t.zy[l6]) / this.m.sin(90 - this.t.zy[l6])
                                 - this.t.radz[l6] * this.m.sin(this.t.zy[l6]) / this.m.sin(90 - this.t.zy[l6])
                           )
                     );
                  }
                  ...
                  if (this.t.xy[l6] != 0) {
                     ai2[j8] = (int)(
                        ai2[j8]
                           + (
                              (ai[j8] - (this.t.x[l6] - this.m.x - this.t.radx[l6])) * this.m.sin(this.t.xy[l6]) / this.m.sin(90 - this.t.xy[l6])
                                 - this.t.radx[l6] * this.m.sin(this.t.xy[l6]) / this.m.sin(90 - this.t.xy[l6])
                           )
                     );
                  }
               }

               i2 = (int)(this.t.c[l6][0] / 1.5);
               j2 = (int)(this.t.c[l6][1] / 1.5);
               k2 = (int)(this.t.c[l6][2] / 1.5);
               break;
            }
         }
      }
      ...
      if (k1 == 2) {
         ...
         for (int i4 = 0; i4 < this.m.nsp; i4++) {
            for (int j5 = 0; j5 < this.n; j5++) {
               if (Math.abs(ai[j5] - this.m.spx[i4]) < this.m.sprad[i4] && Math.abs(ai1[j5] - this.m.spz[i4]) < this.m.sprad[i4]) {
                  flag = false;
               }
            }
         }
