...
public class xtGraphics extends Panel {
   ...
   float[] proba = new float[]{0.5F, 0.5F, 0.5F, 0.5F, 0.5F, 0.5F, 0.5F, 0.5F, 0.5F, 0.5F};
   float[] dishandle = new float[]{0.5F, 0.6F, 0.55F, 0.67F, 0.45F, 0.9F, 0.7F, 0.6F, 1.0F, 0.85F};
   int holdcnt;
   boolean winner;
   int[] flexpix;
   Image fleximg;
   ...
   String[] names = new String[]{
      "Ice Bullet", "LiquidMetal Prototype", "Safari Wrangler", "Hip-E", "Stinger Z3", "Dirty Buffalo", "Gespenst", "Der Führer", "Radical X", "Chaos Chariot"
   };
   int dmcnt;
   boolean dmflk;
   int pwcnt;
   ...
   String[][] adj = new String[][]{
      {"Cool", "Great", "Nice"},
      {"Wicked", "Amazing", "Awesome"},
      {"Outstanding", "Insane", "Radical"},
      {"What the...?", "You're made of WIN!!!!", "o.O"},
   ...
   public void framer(int i, Graphics g) {
      ...
      if (i == 10) {
         this.drawcs(g, 300, "> Figure out your own path... Cause the arrow wont help you!", 100, 100, 100, 4);
      }

      if (i == this.unlocked) {
         if (i == 1) {
            this.drawcs(g, 300, "> Go through the checkpoints... That's all you need to know...", 100, 100, 100, 4);
         }

         if (i == 2) {
            this.drawcs(g, 300, "> Do stunts... The more fuel you have, the better...", 100, 100, 100, 4);
         }

         if (i == 3) {
            this.drawcs(g, 300, "> You can also waste other cars if you want... I'm not stopping you...", 100, 100, 100, 4);
            this.drawcs(g, 320, "( Press [A] to make Guidance Arrow point to cars )", 100, 100, 100, 4);
         }

         if (i == 4) {
            this.drawcs(g, 300, "> Remember the better the stunt the more fuel you get...", 100, 100, 100, 4);
         }

         if (i == 5) {
            this.drawcs(g, 300, "> If you get Max Fuel your car will be faster and more resistant...", 100, 100, 100, 4);
         }
      }
   }
   ...
   public void loadingstage(int i, Graphics g) {
      ...
      g.setFont(new Font("SansSerif", 1, 13));
      this.ftm = g.getFontMetrics();
      this.drawcs(g, 180, "Loading Stage " + i + ", be patient...", 0, 0, 0, 3);
      g.drawImage(this.select, 201, 45, null);
      g.drawImage(this.bl, 0, 0, null);
      g.drawImage(this.bt, 0, 0, null);
      g.drawImage(this.br, 509, 0, null);
   ...
   public void arrow(Graphics g, int i, int j, CheckPoints checkpoints, boolean flag) {
      ...
      if (!flag) {
         ...
         var17 = (int)(
            90 + var36 + Math.atan((double)(checkpoints.opz[l] - checkpoints.opz[0]) / (checkpoints.opx[l] - checkpoints.opx[0])) / (Math.PI / 180.0)
         );
   ...
   public void levelhigh(Graphics g, int i, int j) {
      ...
      if (i != 0) {
         this.drawcs(g, 60, "You wasted 'em!", 160, 8, 6, 0);
      } else if (j == 229) {
         this.drawcs(g, 60, "Wasted!", 160, 8, 6, 0);
      } else {
         this.drawcs(g, 60, "Stunts!", 6, 208, 6, 0);
      }
   ...
   public void loadpak1(MediaTracker mediatracker, Toolkit toolkit) {
      try {
         File file = new File("/app/games/nfm-mdx-v2/graphics/images1.zipo");
   ...
   public void nofocus(Graphics g) {
      ...
      g.setFont(new Font("SansSerif", 1, 11));
      this.ftm = g.getFontMetrics();
      this.drawcs(g, 14, "Hey! Get back to the game!!!!", 100, 100, 100, 3);
      this.drawcs(g, 395, "C'mon I don't have all day!", 100, 100, 100, 3);
   }
   ...
   public void credits(Graphics g, Control control) {
      ...
      if (this.flipo == 1) {
         ...
         g.drawImage(this.rpro, 150, 240, null);
      }
      ...
      if (this.flipo == 2) {
         ...
         this.drawcs(g, 100, "Original Need For Madness", 0, 0, 0, 3);
         this.drawcs(g, 120, "By Omar Waly", 0, 0, 100, 3);
         this.drawcs(g, 180, "Tracks, Images, Cars and other stuff", 0, 0, 0, 3);
         this.drawcs(g, 200, "by André (MoGa_DeX) Lopes", 0, 0, 100, 3);
         this.drawcs(g, 215, "This version of the game was updated and is maintained", 0, 0, 0, 3);
         this.drawcs(g, 230, "By Jaroslav Paska (Phyrexian)", 0, 0, 100, 3);
         this.drawcs(g, 245, "Thank you to all the people who waited for this and supported me!", 150, 0, 0, 3);
         this.drawcs(g, 305, "Music From", 0, 0, 0, 3);
         this.drawcs(g, 325, "www.ModArchive.com", 0, 0, 100, 3);
   ...
   public void stat(Madness madness, CheckPoints checkpoints, Control control, boolean flag, Graphics g) {
      ...
      if (this.wasted == 4) {
         ...
         if (this.aflk) {
            this.drawcs(g, 120, "You Won, all racers have been wasted!", 0, 0, 0, 0);
            this.aflk = false;
         } else {
            this.drawcs(g, 120, "You Won, all racers have been wasted!", 0, 128, 255, 0);
            this.aflk = true;
         }
         ...
         do {
            if (checkpoints.clear[i] == checkpoints.nlaps * checkpoints.nsp && checkpoints.pos[i] == 0) {
               if (i == 0) {
                  ...
                  if (this.aflk) {
                     this.drawcs(g, 120, "You finished first, great race!", 0, 0, 0, 0);
                     this.aflk = false;
                  } else {
                     this.drawcs(g, 120, "You finished first, great race!", 0, 255, 128, 0);
                     this.aflk = true;
                  }
                  ...
                  if (this.aflk) {
                     this.drawcs(g, 120, "" + this.names[this.sc[i]] + " finished first, you fail!", 0, 0, 0, 0);
                     this.aflk = false;
                  } else {
                     this.drawcs(g, 120, "" + this.names[this.sc[i]] + " finished first, you fail!", 160, 0, 0, 0);
                     this.aflk = true;
                  }
      ...
      if (!flag1) {
         ...
         if (madness.power < 45.0F) {
            if (this.tcnt == 30 && this.auscnt == 45 && madness.mtouch && madness.capcnt == 0) {
               if (this.pwcnt < 70) {
                  if (this.looped != 3) {
                     if (this.pwflk) {
                        this.drawcs(g, 110, "Fuel low, perform stunt!", 0, 0, 200, 0);
                        this.pwflk = false;
                     } else {
                        this.drawcs(g, 110, "Fuel low, perform stunt!", 255, 100, 0, 0);
                        this.pwflk = true;
                     }
                  } else if (this.pwflk) {
         ...
         if (madness.capcnt == 0) {
            ...
            this.drawcs(g, 110, "Stunt Failed!", 0, 0, 200, 0);
            this.tflk = false;
         } else {
            this.drawcs(g, 110, "Stunt Failed!", 255, 100, 0, 0);
            this.tflk = true;
         }
         ...
         if (madness.trcnt == 10) {
            ...
            if (this.auscnt < 45) {
               ...
               if (!this.wasay) {
                  ...
                  if (madness.power != 98.0F) {
                     this.say = "Fuel Up by: " + (int)(100.0F * madness.powerup / 98.0F) + "%";
                  } else {
                     this.say = "Fuel Tank FULL!";
                  }
               }
            }
         }
      ...
      if (this.winner) {
         if (checkpoints.stage == this.unlocked) {
            if (checkpoints.stage != 11) {
               ...
               this.drawcs(g, 80, "You beat stage " + checkpoints.stage + " : " + checkpoints.name + " !", 144, 167, 255, 3);
            } else {
            ...
            if (checkpoints.stage != 11) {
               ...
               if (this.aflk) {
                  this.drawcs(g, 150, "You are the definition of AWESOME!", 144, 167, 255, 3);
               } else {
                  this.drawcs(g, 152, "You are the definition of AWESOME!", 228, 240, 255, 3);
               }

               if (this.aflk) {
                  this.drawcs(g, 200, "Thanks for playing!", 144, 167, 255, 3);
               } else {
                  this.drawcs(g, 200, "Thanks for playing!", 228, 240, 255, 3);
               }
               ...
               this.ftm = g.getFontMetrics();
               if (this.aflk) {
                  this.drawcs(g, 270, "Be sure to check aimgames.forummotion.com for more NFM than your mind can handle!", 144, 167, 255, 3);
               } else {
                  this.drawcs(g, 270, "Be sure to check aimgames.forummotion.com for more NFM than your mind can handle!", 208, 240, 255, 3);
               }
            ...
            this.drawcs(g, 167, "You beat stage " + checkpoints.stage + " : " + checkpoints.name + " !", 144, 167, 255, 3);
         }
      } else {
         this.pin = 100;
         ...
         if (checkpoints.stage == this.unlocked) {
            if (checkpoints.stage == 1) {
               this.drawcs(g, 205, "> Pass through all checkpoints in order to complete a lap...", 128, 128, 128, 3);
            }

            if (checkpoints.stage == 2) {
               this.drawcs(g, 205, "> If you're all beaten up just go through the fixing hoop...", 128, 128, 128, 3);
            }

            if (checkpoints.stage == 3) {
               this.drawcs(g, 205, "> If you can't keep up with them, waste'em...", 128, 128, 128, 3);
               this.drawcs(g, 220, "( Press [A] to make Guidance Arrow point to cars )", 128, 128, 128, 3);
            }

            if (checkpoints.stage == 4) {
               this.drawcs(g, 205, "> Do crazy stunts... You get more fuel for those...", 128, 128, 128, 3);
            }

            if (checkpoints.stage == 5) {
               this.drawcs(g, 205, "> Stunt away... Even when your fuel tank is full...", 128, 128, 128, 3);
            }
         }
      }
   ...
   public void sortcars(int i) {
      if (i != 0) {
         ...
         if (this.unlocked == i && this.unlocked != 11) {
            this.sc[4] = 4 + (i + 1) / 2;
            int j = 1;
   ...
   public void stageselect(Graphics g, CheckPoints checkpoints, Control control) {
      ...
      this.ftm = g.getFontMetrics();
      if (checkpoints.stage != 11) {
         this.drawcs(g, 110, "Stage " + checkpoints.stage + "  >", 0, 200, 0, 3);
      } else {
         this.drawcs(g, 110, "Final Party Stage  >", 255, 255, 255, 3);
      }

      this.drawcs(g, 130, "| " + checkpoints.name + " |", 32, 48, 148, 3);
      g.setFont(new Font("SansSerif", 1, 11));
      this.ftm = g.getFontMetrics();
      this.drawcs(g, 396, "Use keyboard Arrows and press Enter to continue", 0, 0, 0, 3);
   ...
   public void loadpak2(MediaTracker mediatracker, Toolkit toolkit) {
      try {
         File file = new File("/app/games/nfm-mdx-v2/graphics/images2.zipo");
         DataInputStream datainputstream = new DataInputStream(new FileInputStream(file));
         ZipInputStream zipinputstream = new ZipInputStream(datainputstream);
   ...
   public void loading(Graphics g, Panel panel) {
      g.setColor(new Color(0, 0, 0));
      g.fillRect(0, 0, 550, 400);
      ...
      this.drawcs(
         ...
         385,
         ""
            + (int)((26.0F + (float)this.dnload / this.kbload * 200.0F) / 226.0F * 100.0F)
            + " % loaded    |    "
   ...
   public void cantreply(Graphics g) {
      ...
      this.drawcs(g, 187, "Not enough replay data, please try again later.", 255, 255, 255, 1);
   }

   public void loadpak3(MediaTracker mediatracker, Toolkit toolkit) {
      try {
         File file = new File("/app/games/nfm-mdx-v2/graphics/images3.zipo");
         DataInputStream datainputstream = new DataInputStream(new FileInputStream(file));
         ZipInputStream zipinputstream = new ZipInputStream(datainputstream);
   ...
   public void carselect(Control control, ContO[] aconto, Madness madness, Graphics g) {
      ...
      g.setFont(new Font("SansSerif", 1, 11));
      this.ftm = g.getFontMetrics();
      this.drawcs(g, 396, "Use keyboard Arrows and press Enter to continue", 0, 21, 0, 3);
      if (control.right) {
         control.right = false;
   ...
   public void loadingfailed(int i, Control control, Graphics g) {
      ...
      this.drawcs(g, 170, "You Fail.", 0, 0, 0, 3);
   ...
   private Clip getSound(String s) {
      ...
      try {
         AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File("/app/games/nfm-mdx-v2/" + s));
   ...
   private Image getImage(String s) {
      ...
      try {
         image = ImageIO.read(new File("/app/games/nfm-mdx-v2/" + s));
      } catch (Exception var4) {
         var4.printStackTrace();
      }
   ...
   public void loadpak4(MediaTracker mediatracker, Toolkit toolkit) {
      try {
         File file = new File("/app/games/nfm-mdx-v2/graphics/images4.zipo");
         DataInputStream datainputstream = new DataInputStream(new FileInputStream(file));
         ZipInputStream zipinputstream = new ZipInputStream(datainputstream);
