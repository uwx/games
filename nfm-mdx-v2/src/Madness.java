...
public class Madness {
   ...
   int[] handb = new int[]{7, 10, 7, 10, 16, 8, 9, 13, 7, 7};
   float[] airs = new float[]{0.94F, 0.9F, 0.95F, 0.5F, 1.07F, 1.0F, 0.9F, 0.8F, 1.5F, 1.0F};
   int[] airc = new int[]{56, 30, 40, 25, 45, 50, 40, 10, 125, 60};
   float[] drag = new float[]{0.5F, 0.5F, 0.5F, 0.5F, 0.5F, 0.5F, 0.5F, 0.5F, 0.5F, 0.5F};
   int[] turn = new int[]{6, 9, 5, 7, 7, 7, 5, 4, 7, 6};
   float[] grip = new float[]{25.0F, 27.0F, 18.0F, 19.0F, 20.0F, 20.0F, 25.0F, 25.0F, 25.0F, 27.0F};
   float[] bounce = new float[]{1.2F, 1.05F, 1.3F, 1.0F, 1.15F, 1.2F, 1.15F, 0.8F, 1.1F, 1.15F};
   float[] simag = new float[]{0.9F, 0.85F, 1.05F, 1.1F, 0.9F, 0.9F, 1.05F, 1.1F, 0.9F, 1.15F};
   float[] moment = new float[]{1.2F, 1.0F, 1.4F, 1.0F, 1.0F, 1.25F, 1.4F, 2.0F, 1.5F, 2.0F};
   float[] comprad = new float[]{0.5F, 0.6F, 0.8F, 1.2F, 0.5F, 0.5F, 0.5F, 1.5F, 0.5F, 0.8F};
   int[] push = new int[]{2, 2, 3, 4, 3, 2, 2, 4, 2, 2};
   int[] revpush = new int[]{2, 3, 2, 4, 3, 2, 2, 1, 2, 1};
   int[] lift = new int[]{0, 0, 0, 20, 20, 30, 0, 0, 50, 0};
   int[] revlift = new int[]{0, 0, 15, 0, 0, 0, 0, 0, 0, 32};
   int[] powerloss = new int[]{3500000, 2500000, 3500000, 4456608, 2717344, 2500000, 3200000, 4500000, 3000000, 5500000};
   int[] flipy = new int[]{-90, -26, -90, -70, -41, -53, -54, -85, -60, -127};
   int[] msquash = new int[]{7, 3, 7, 6, 3, 3, 6, 10, 3, 8};
   int[] clrad = new int[]{4700, 1500, 4700, 2700, 3000, 2100, 3500, 7000, 4000, 4000};
   int[] maxmag = new int[]{7500, 3500, 7500, 6496, 5200, 4100, 6000, 9000, 4400, 9500};
   float[] dammult = new float[]{0.9375F, 1.488F, 0.9375F, 0.8F, 1.0609F, 0.9066F, 1.0F, 0.6666F, 0.8266F, 0.7667F};
   int[] outdam = new int[]{80, 50, 80, 131, 88, 75, 81, 100, 75, 110};
   boolean[] dominate;
   boolean[] caught;
   int pzy;
   int pxy;
   ...
   public void drive(Control control, ContO conto, Trackers trackers, CheckPoints checkpoints) {
      ...
      do {
         if (af2[l4] > 245.0F) {
            ...
            do {
               if (l4 != fi9 && af2[fi9] <= 245.0F) {
                  af2[fi9] -= af2[l4] - 250.0F;
               }
            } while (++fi9 < 4);
         ...
         do {
            if (!aflag[i7]
               ...
               if (trackers.xy[j5] == 0 && trackers.zy[j5] == 0 && trackers.y[j5] != 250 && af2[i7] > trackers.y[j5] - 5) {
                  ...
                  do {
                     if (i7 != fi14 && af2[fi14] <= trackers.y[j5] - 5) {
                        af2[fi14] -= af2[i7] - trackers.y[j5];
                     }
                  } while (++fi14 < 4);
               ...
               if (trackers.zy[j5] == -90 && af1[i7] < trackers.z[j5] + trackers.radz[j5] && this.scz[i7] < 0.0F) {
                  ...
                  do {
                     if (i7 != fi15 && af1[fi15] >= trackers.z[j5] + trackers.radz[j5]) {
                        af1[fi15] -= af1[i7] - (trackers.z[j5] + trackers.radz[j5]);
                     }
                  } while (++fi15 < 4);
               ...
               if (trackers.zy[j5] == 90 && af1[i7] > trackers.z[j5] - trackers.radz[j5] && this.scz[i7] > 0.0F) {
                  ...
                  do {
                     if (i7 != fi16 && af1[fi16] <= trackers.z[j5] - trackers.radz[j5]) {
                        af1[fi16] -= af1[i7] - (trackers.z[j5] - trackers.radz[j5]);
                     }
                  } while (++fi16 < 4);
               ...
               if (trackers.xy[j5] == -90 && af[i7] < trackers.x[j5] + trackers.radx[j5] && this.scx[i7] < 0.0F) {
                  ...
                  do {
                     if (i7 != fi17 && af[fi17] >= trackers.x[j5] + trackers.radx[j5]) {
                        af[fi17] -= af[i7] - (trackers.x[j5] + trackers.radx[j5]);
                     }
                  } while (++fi17 < 4);
               ...
               if (trackers.xy[j5] == 90 && af[i7] > trackers.x[j5] - trackers.radx[j5] && this.scx[i7] > 0.0F) {
                  ...
                  do {
                     if (i7 != fi18 && af[fi18] <= trackers.x[j5] - trackers.radx[j5]) {
                        af[fi18] -= af[i7] - (trackers.x[j5] - trackers.radx[j5]);
                     }
                  } while (++fi18 < 4);
