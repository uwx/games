...
public class Madness
{
    ...
    float moment[] = {
        ...
        1.375F, 2.0F, 1.2F, 3F, 1.5F, 2.0F
    };
    float comprad[] = {
        0.5F, 0.4F, 0.8F, 0.5F, 0.3F, 0.5F, 0.5F, 0.5F, 0.5F, 0.8F, 
        0.5F, 1.0F, 0.5F, 0.6F, 0.5F, 0.8F
    };
    int push[] = {
        2, 2, 3, 3, 2, 2, 2, 4, 2, 2, 
        2, 4, 2, 2, 2, 2
                ...
                for(int l = 0; l < conto.npl; l++)
                {
                    ...
                    if(f1 != 0.0F)
                    {
                        ...
                        if(!conto.p[l].nocol && !conto.p[l].glass)
                        {
                            ...
                            if(conto.p[l].bfase > 25 && (double)conto.p[l].hsb[2] > 0.69999999999999996D)
                            {
                                conto.p[l].hsb[2] = 0.7F;
                            }
                            if(conto.p[l].bfase > 30 && (double)conto.p[l].hsb[1] > 0.14999999999999999D)
                            {
                                conto.p[l].hsb[1] = 0.15F;
                            }
                            if(conto.p[l].bfase > 35 && (double)conto.p[l].hsb[2] > 0.59999999999999998D)
                            {
                            ...
                            if(conto.p[l].bfase > 50 && (double)conto.p[l].hsb[2] > 0.5D)
                            {
            ...
            for(int j = 0; j < conto.npl; j++)
            {
                ...
                if(f1 != 0.0F)
                {
                    ...
                    if(!conto.p[j].nocol && !conto.p[j].glass)
                    {
                        ...
                        if(conto.p[j].bfase > 25 && (double)conto.p[j].hsb[2] > 0.69999999999999996D)
                        {
                            conto.p[j].hsb[2] = 0.7F;
                        }
                        if(conto.p[j].bfase > 30 && (double)conto.p[j].hsb[1] > 0.14999999999999999D)
                        {
                            conto.p[j].hsb[1] = 0.15F;
                        }
                        if(conto.p[j].bfase > 35 && (double)conto.p[j].hsb[2] > 0.59999999999999998D)
                        {
                        ...
                        if(conto.p[j].bfase > 50 && (double)conto.p[j].hsb[2] > 0.5D)
                        {
    ...
    public void drive(Control control, ContO conto, Trackers trackers, CheckPoints checkpoints)
    {
        ...
        if(mtouch)
        {
            ...
            do
            {
                ...
                if(k3 == 4)
                {
                    ...
                    scy[l7] = (float)((double)(-150F * m.random() * (speed / (float)swits[cn][2])) * ((double)bounce[cn] - 0.29999999999999999D));
                }
                f9 += scx[l6];
                f10 += scz[l6];
            } while(++l6 < 4);
        ...
        do
        {
            if(af2[l4] > 245F)
            {
                ...
                do
                {
                    if(l4 != i8 && af2[i8] <= 245F)
                    {
                        af2[i8] -= af2[l4] - 250F;
                    }
                } while(++i8 < 4);
                float f8 = Math.abs(m.sin(pxy)) + Math.abs(m.sin(pzy));
                f8 /= 3F;
            ...
            do
            {
                if(!aflag[i7] && af[i7] > (float)(trackers.x[j5] - trackers.radx[j5]) && af[i7] < (float)(trackers.x[j5] + trackers.radx[j5]) && af1[i7] > (float)(trackers.z[j5] - trackers.radz[j5]) && af1[i7] < (float)(trackers.z[j5] + trackers.radz[j5]) && af2[i7] > (float)(trackers.y[j5] - trackers.rady[j5]) && af2[i7] < (float)(trackers.y[j5] + trackers.rady[j5]))
                {
                    if(trackers.xy[j5] == 0 && trackers.zy[j5] == 0 && trackers.y[j5] != 250 && af2[i7] > (float)(trackers.y[j5] - 5))
                    {
                        ...
                        do
                        {
                            if(i7 != i13 && af2[i13] <= (float)(trackers.y[j5] - 5))
                            {
                                af2[i13] -= af2[i7] - (float)trackers.y[j5];
                            }
                        } while(++i13 < 4);
                        float f13 = Math.abs(m.sin(pxy)) + Math.abs(m.sin(pzy));
                        f13 /= 3F;
                    ...
                    if(trackers.zy[j5] == -90 && af1[i7] < (float)(trackers.z[j5] + trackers.radz[j5]) && scz[i7] < 0.0F)
                    {
                        ...
                        do
                        {
                            if(i7 != i14 && af1[i14] >= (float)(trackers.z[j5] + trackers.radz[j5]))
                            {
                                af1[i14] -= af1[i7] - (float)(trackers.z[j5] + trackers.radz[j5]);
                            }
                        } while(++i14 < 4);
                        float f14 = Math.abs(m.cos(pxy)) + Math.abs(m.cos(pzy));
                        f14 /= 4F;
                    ...
                    if(trackers.zy[j5] == 90 && af1[i7] > (float)(trackers.z[j5] - trackers.radz[j5]) && scz[i7] > 0.0F)
                    {
                        ...
                        do
                        {
                            if(i7 != i15 && af1[i15] <= (float)(trackers.z[j5] - trackers.radz[j5]))
                            {
                                af1[i15] -= af1[i7] - (float)(trackers.z[j5] - trackers.radz[j5]);
                            }
                        } while(++i15 < 4);
                        float f15 = Math.abs(m.cos(pxy)) + Math.abs(m.cos(pzy));
                        f15 /= 4F;
                    ...
                    if(trackers.xy[j5] == -90 && af[i7] < (float)(trackers.x[j5] + trackers.radx[j5]) && scx[i7] < 0.0F)
                    {
                        ...
                        do
                        {
                            if(i7 != i16 && af[i16] >= (float)(trackers.x[j5] + trackers.radx[j5]))
                            {
                                af[i16] -= af[i7] - (float)(trackers.x[j5] + trackers.radx[j5]);
                            }
                        } while(++i16 < 4);
                        float f16 = Math.abs(m.cos(pxy)) + Math.abs(m.cos(pzy));
                        f16 /= 4F;
                    ...
                    if(trackers.xy[j5] == 90 && af[i7] > (float)(trackers.x[j5] - trackers.radx[j5]) && scx[i7] > 0.0F)
                    {
                        ...
                        do
                        {
                            if(i7 != i17 && af[i17] <= (float)(trackers.x[j5] - trackers.radx[j5]))
                            {
                                af[i17] -= af[i7] - (float)(trackers.x[j5] - trackers.radx[j5]);
                            }
                        } while(++i17 < 4);
                        float f17 = Math.abs(m.cos(pxy)) + Math.abs(m.cos(pzy));
                        f17 /= 4F;
                    ...
                    if(trackers.zy[j5] != 0 && trackers.zy[j5] != 90 && trackers.zy[j5] != -90)
                    {
                        ...
                        float f21 = (float)trackers.y[j5] + ((af2[i7] - (float)trackers.y[j5]) * m.cos(i8) - (af1[i7] - (float)trackers.z[j5]) * m.sin(i8));
                        float f23 = (float)trackers.z[j5] + ((af2[i7] - (float)trackers.y[j5]) * m.sin(i8) + (af1[i7] - (float)trackers.z[j5]) * m.cos(i8));
                        ...
                        af2[i7] = (float)trackers.y[j5] + ((f21 - (float)trackers.y[j5]) * m.cos(-i8) - (f23 - (float)trackers.z[j5]) * m.sin(-i8));
                        af1[i7] = (float)trackers.z[j5] + ((f21 - (float)trackers.y[j5]) * m.sin(-i8) + (f23 - (float)trackers.z[j5]) * m.cos(-i8));
                        aflag[i7] = true;
                    }
                    if(trackers.xy[j5] != 0 && trackers.xy[j5] != 90 && trackers.xy[j5] != -90)
                    {
                        ...
                        float f22 = (float)trackers.y[j5] + ((af2[i7] - (float)trackers.y[j5]) * m.cos(j8) - (af[i7] - (float)trackers.x[j5]) * m.sin(j8));
                        float f24 = (float)trackers.x[j5] + ((af2[i7] - (float)trackers.y[j5]) * m.sin(j8) + (af[i7] - (float)trackers.x[j5]) * m.cos(j8));
                        ...
                        af2[i7] = (float)trackers.y[j5] + ((f22 - (float)trackers.y[j5]) * m.cos(-j8) - (f24 - (float)trackers.x[j5]) * m.sin(-j8));
                        af[i7] = (float)trackers.x[j5] + ((f22 - (float)trackers.y[j5]) * m.sin(-j8) + (f24 - (float)trackers.x[j5]) * m.cos(-j8));
                        aflag[i7] = true;
                    }
                }
            } while(++i7 < 4);
        ...
        for(int j10 = 0; j10 < checkpoints.n; j10++)
        {
            if(checkpoints.typ[j10] > 0)
            {
                ...
                if(checkpoints.typ[j10] == 1)
                {
                    ...
                    if((float)Math.abs(conto.z - checkpoints.z[j10]) < 60F + Math.abs(scz[0] + scz[1] + scz[2] + scz[3]) / 4F && Math.abs(conto.x - checkpoints.x[j10]) < 700 && Math.abs(conto.y - checkpoints.y[j10]) < 800 && clear == (l9 + nlaps * checkpoints.nsp) - 1)
                    {
                ...
                if(checkpoints.typ[j10] == 2)
                {
                    ...
                    if((float)Math.abs(conto.x - checkpoints.x[j10]) < 60F + Math.abs(scx[0] + scx[1] + scx[2] + scx[3]) / 4F && Math.abs(conto.z - checkpoints.z[j10]) < 700 && Math.abs(conto.y - checkpoints.y[j10]) < 800 && clear == (l9 + nlaps * checkpoints.nsp) - 1)
                    {
                        clear = l9 + nlaps * checkpoints.nsp;
                        pcleared = j10;
                        focus = -1;
            ...
            if(py(conto.x / 100, checkpoints.x[j10] / 100, conto.z / 100, checkpoints.z[j10] / 100) * j < k9 || k9 == 0)
            {
                j9 = j10;
        ...
        for(int k10 = 0; k10 < checkpoints.fn; k10++)
        {
            ...
            {
                if(Math.abs(conto.z - checkpoints.fz[k10]) < 200 && py(conto.x / 100, checkpoints.fx[k10] / 100, conto.y / 100, checkpoints.fy[k10] / 100) < 30)
                {
                    if(conto.dist == 0)
                    {
                        conto.fcnt = 8;
            ...
            if(Math.abs(conto.x - checkpoints.fx[k10]) < 200 && py(conto.z / 100, checkpoints.fz[k10] / 100, conto.y / 100, checkpoints.fy[k10] / 100) < 30)
            {
                if(conto.dist == 0)
                {
                    conto.fcnt = 8;
            ...
            if(!capsized)
            {
                ...
                if(gtouch && trcnt != 0)
                {
                    if(trcnt == 9)
                    {
                        ...
                        power += powerup;
                        if(im == 0 && (int)powerup > rpd.powered && rpd.wasted == 0 && (powerup > 60F || checkpoints.stage <= 2))
                        {
                            rpdcatch = 30;
                            if(rpd.hcaught)
                            {
