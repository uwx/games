      ...
      if (!madness.dest) {
            ...
            if (this.stcnt > this.statusque) {
               ...
               if (this.cntrn == 0) {
                  ...
                  if (checkpoints.stage == 7
                     ...
                     || checkpoints.stage == 33
                     || checkpoints.stage == 34
                     || checkpoints.stage == 46
                     || checkpoints.stage == 50) {
                     this.agressed = true;
                  }
               ...
               if (this.attack == 0) {
                  ...
                  if (checkpoints.stage == 8 || checkpoints.stage == 6 || checkpoints.stage == 14) {
                     flag1 = false;
                  }
                  ...
                  do {
                     if (i3 != madness.im && checkpoints.clear[i3] != -1) {
                        ...
                        int i5 = (int)('Z' + c2 + Math.atan((double)(checkpoints.opz[i3] - conto.z) / (checkpoints.opx[i3] - conto.x)) / (Math.PI / 180.0));
                        ...
                        if (j5 < 85 + 15 * (Math.abs(checkpoints.clear[i3] - madness.clear) + 1)
                           && this.py(conto.x / 100, checkpoints.opx[i3] / 100, conto.z / 100, checkpoints.opz[i3] / 100) < k5
                           && this.afta
                           && madness.power > k1) {
                           ...
                           float f2 = (checkpoints.pos[madness.im] + 1) * (5 - checkpoints.pos[i3]) / f1;
                           if (checkpoints.stage != 11 && f2 > 0.7) {
                              f2 = 0.7F;
                           }
                           ...
                           if (checkpoints.stage == 6 || checkpoints.stage == 14) {
                              f2 = 0.0F;
                           ...
                           if (checkpoints.stage == 8 || checkpoints.stage == 14 || checkpoints.stage == 48) {
                              f2 = 0.0F;
                           }
                        ...
                        if (flag1
                           && j5 > 100
                           && this.py(conto.x / 100, checkpoints.opx[i3] / 100, conto.z / 100, checkpoints.opz[i3] / 100) < 300
               ...
               boolean flag2 = false;
               if (checkpoints.stage == 6 || checkpoints.stage == 8 || checkpoints.stage == 11 || checkpoints.stage == 14) {
                  flag2 = true;
               }
               ...
               if (this.trfix != 3) {
                  ...
                  if (!flag2 && 100.0F * madness.hitmag / madness.maxmag[madness.cn] > 80.0F) {
                     this.trfix = 2;
                  }
               } else {
                  this.upwait = 0;
               ...
               if (!this.bulistc) {
                  ...
                  if (checkpoints.stage == 9
                     && this.afta
                     && (checkpoints.pos[madness.im] == 4 || checkpoints.pos[madness.im] == 3)
                     && madness.cn != 9
                     && this.trfix != 0) {
                     this.bulistc = true;
                  }
         ...
         if (flag) {
            ...
            if (this.attack != 0) {
               ...
               this.pan = (int)('Z' + c + Math.atan((double)(checkpoints.opz[this.acr] - conto.z) / (checkpoints.opx[this.acr] - conto.x)) / (Math.PI / 180.0));
               this.attack--;
               if (this.attack <= 0) {
                  this.attack = 0;
               }
               ...
               if (this.bulistc && this.trfix != 2 && this.trfix != 3 && this.trfix != 4 && !(madness.power < j1)) {
                  i -= 2;
                  if (i < 0) {
                     i += checkpoints.n;
                  }
                  ...
                  if (this.rampp == 2) {
                     ...
                     if (checkpoints.typ[j2] == -2 && i != madness.point) {
                        if (--i < 0) {
                           i += checkpoints.n;
                        }
                     }
               ...
               if (checkpoints.stage != 11
                  || checkpoints.stage != 33 && (madness.missedcp == 0 || this.forget || this.trfix == 4 || checkpoints.stage == 10) && this.trfix != 0) {
                  if (this.trfix == 2) {
                     int k2 = -10;
                     int j3 = 0;

                     for (int j4 = 0; j4 < checkpoints.fn; j4++) {
                        if (this.py(conto.x / 100, checkpoints.x[this.fpnt[j4]] / 100, conto.z / 100, checkpoints.z[this.fpnt[j4]] / 100) < k2 || k2 == -10) {
                  ...
                  for (int l2 = 0; l2 < checkpoints.fn; l2++) {
                     if (this.py(conto.x / 100, checkpoints.x[this.fpnt[l2]] / 100, conto.z / 100, checkpoints.z[this.fpnt[l2]] / 100) < 2000) {
                        this.forget = false;
                        this.actwait = 0;
                        this.upwait = 0;
                        this.turntyp = 2;
            ...
            if (this.trickfase == 0) {
               ...
               if (k > 9 && this.m.random() > this.trickprf / 3.0F) {
                  ...
                  if (k < 16) {
                     ...
                     this.udstart = 0;
                     this.udswt = false;
                  } else if (!(this.m.random() > this.m.random()) && checkpoints.stage != 8 && checkpoints.stage != 14 && checkpoints.stage != 48) {
   ...
   public void reset(CheckPoints checkpoints) {
      ...
      for (int i = 0; i < checkpoints.fn; i++) {
         ...
         for (int l = 0; l < checkpoints.n; l++) {
            if (this.py(checkpoints.fx[i] / 100, checkpoints.x[l] / 100, checkpoints.fz[i] / 100, checkpoints.z[l] / 100) < k || k == -10) {
      ...
      for (int j = 0; j < checkpoints.fn; j++) {
         this.fpnt[j] = this.fpnt[j] - 4;
         if (this.fpnt[j] < 0) {
            this.fpnt[j] = this.fpnt[j] + checkpoints.nsp;
         }
      }
