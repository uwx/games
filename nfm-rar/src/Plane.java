...
public class Plane {
         ...
         do {
            if (j != i) {
               this.projf = this.projf
                  * (float)(Math.sqrt((this.ox[i] - this.ox[j]) * (this.ox[i] - this.ox[j]) + (this.oz[i] - this.oz[j]) * (this.oz[i] - this.oz[j])) / 100.0);
            }
         } while (++j < 3);
      } while (++i < 3);
   ...
   public Plane(
      ...
      if (!flag) {
         ...
         do {
            this.c[l2] = (int)(ai3[l2] + ai3[l2] * (this.m.snap[l2] / 100.0F));
            if (this.c[l2] > 255) {
               this.c[l2] = 255;
            }
         ...
         do {
            if (i3 != l2) {
               this.deltaf = this.deltaf
                  * (float)(
                     Math.sqrt(
                           (this.ox[i3] - this.ox[l2]) * (this.ox[i3] - this.ox[l2])
                              + (this.oy[i3] - this.oy[l2]) * (this.oy[i3] - this.oy[l2])
                              + (this.oz[i3] - this.oz[l2]) * (this.oz[i3] - this.oz[l2])
                        )
                        / 100.0
                  );
            }
   ...
   public void d(Graphics g, int i, int j, int k, int l, int i1, int j1, int k1, int l1, boolean flag) {
      ...
      if (this.embos == 0) {
         ...
         if (this.embos <= 11 && this.m.random() > 0.5 && !this.glass) {
            for (int j2 = 0; j2 < this.n; j2++) {
               ai[j2] = (int)(this.ox[j2] + i + (15.0F - this.m.random() * 30.0F));
               ai2[j2] = (int)(this.oy[j2] + j + (15.0F - this.m.random() * 30.0F));
               ai1[j2] = (int)(this.oz[j2] + k + (15.0F - this.m.random() * 30.0F));
            }
         ...
         if (this.embos >= 16) {
            ...
            int k6 = (int)(Math.abs(ai[0] - ai[1]) / 3 * (0.5 - this.m.random()));
            int j7 = (int)(Math.abs(ai1[0] - ai1[1]) / 3 * (0.5 - this.m.random()));
            ai[2] = (ai[0] + ai[1]) / 2 + k6;
            ai1[2] = (ai1[0] + ai1[1]) / 2 + j7;
            int k7 = (int)((Math.abs(ai[0] - ai[1]) + Math.abs(ai1[0] - ai1[1])) / 1.5 * (this.m.random() / 2.0F + 0.5));
            ...
            i8 = (int)(255.0F + 255.0F * (this.m.snap[0] / 400.0F));
            if (i8 > 255) {
               i8 = 255;
            }
            ...
            int k8 = (int)(169.0F + 169.0F * (this.m.snap[1] / 300.0F));
            if (k8 > 255) {
               k8 = 255;
            }
            ...
            int i9 = (int)(89.0F + 89.0F * (this.m.snap[2] / 200.0F));
            if (i9 > 255) {
               i9 = 255;
            }
            ...
            k8 = (int)(207.0F + 207.0F * (this.m.snap[1] / 300.0F));
            if (k8 > 255) {
               k8 = 255;
            }
            ...
            i9 = (int)(136.0F + 136.0F * (this.m.snap[2] / 200.0F));
            if (i9 > 255) {
               i9 = 255;
            }
         ...
         for (int i3 = 0; i3 < this.n; i3++) {
            if (this.typ == 1) {
               ai[i3] = (int)(this.ox[i3] * f + i);
            } else {
               ai[i3] = this.ox[i3] + i;
            }

            if (this.typ == 2) {
               ai2[i3] = (int)(this.oy[i3] * f + j);
            } else {
               ai2[i3] = this.oy[i3] + j;
            }

            if (this.typ == 3) {
               ai1[i3] = (int)(this.oz[i3] * f + k);
            } else {
               ai1[i3] = this.oz[i3] + k;
            }
         }
      ...
      if (this.chip != 0) {
         if (this.chip == 1) {
            ...
            this.cxy = i1;
            this.czy = j1;
            int k2 = (int)(this.m.random() * this.n);
      ...
      if (i1 != 0 || j1 != 0 || l != 0) {
         ...
         do {
            ...
            do {
               if (j3 != l2) {
                  this.projf = this.projf * (float)(Math.sqrt((ai[l2] - ai[j3]) * (ai[l2] - ai[j3]) + (ai1[l2] - ai1[j3]) * (ai1[l2] - ai1[j3])) / 100.0);
               }
            } while (++j3 < 3);
         } while (++l2 < 3);
      ...
      if (flag2) {
         ...
         this.av = (int)Math.sqrt(
            (this.m.cy - i14) * (this.m.cy - i14) + (this.m.cx - k14) * (this.m.cx - k14) + i15 * i15 + Math.abs(this.gr * this.gr * this.gr)
         );
      ...
      if (flag2) {
         ...
         if (!flag) {
            if (this.flx == 0) {
               ...
               if (this.flx == 1) {
                  int var93 = 0;
                  l11 = (int)(223.0F + 223.0F * (this.m.snap[1] / 100.0F));
                  if (l11 > 255) {
                     l11 = 255;
                  }
                  ...
                  k12 = (int)(255.0F + 255.0F * (this.m.snap[2] / 100.0F));
                  if (k12 > 255) {
                     k12 = 255;
                  }
                  ...
                  g.setColor(new Color(var93, l11, k12));
                  g.drawPolygon(ai14, ai15, this.n);
                  this.flx = 2;
               }
               ...
               if (this.flx == 3) {
                  int var94 = 0;
                  l11 = (int)(255.0F + 255.0F * (this.m.snap[1] / 100.0F));
                  if (l11 > 255) {
                     l11 = 255;
                  }
                  ...
                  k12 = (int)(223.0F + 223.0F * (this.m.snap[2] / 100.0F));
                  if (k12 > 255) {
                     k12 = 255;
                  }
                  ...
                  g.setColor(new Color(var94, l11, k12));
                  g.drawPolygon(ai14, ai15, this.n);
                  this.flx = 2;
               }
            }
   ...
   public void s(Graphics g, int i, int j, int k, int l, int i1, int j1, int k1) {
      if (this.gr <= 0) {
         ...
         this.rot(ai2, ai1, j, k, j1, this.n);
         this.rot(ai, ai1, i, k, l, this.n);
         int i2 = (int)(this.m.cgrnd[0] / 1.5);
         int j2 = (int)(this.m.cgrnd[1] / 1.5);
         int k2 = (int)(this.m.cgrnd[2] / 1.5);
         ...
         if (k1 == 0) {
            for (int i3 = this.t.nt - 1; i3 >= 0; i3--) {
               ...
               for (int k3 = 0; k3 < this.n; k3++) {
                  if (Math.abs(this.t.zy[i3]) != 90
                     && Math.abs(this.t.xy[i3]) != 90
                     && Math.abs(ai[k3] - (this.t.x[i3] - this.m.x)) < this.t.radx[i3]
                     && Math.abs(ai1[k3] - (this.t.z[i3] - this.m.z)) < this.t.radz[i3]) {
                     j3++;
                  }
               }
                  ...
                  for (int l3 = 0; l3 < this.n; l3++) {
                     ...
                     if (this.t.zy[i3] != 0) {
                        ai2[l3] = (int)(
                           ai2[l3]
                              + (
                                 (ai1[l3] - (this.t.z[i3] - this.m.z - this.t.radz[i3])) * this.m.sin(this.t.zy[i3]) / this.m.sin(90 - this.t.zy[i3])
                                    - this.t.radz[i3] * this.m.sin(this.t.zy[i3]) / this.m.sin(90 - this.t.zy[i3])
                              )
                        );
                     }
                     ...
                     if (this.t.xy[i3] != 0) {
                        ai2[l3] = (int)(
                           ai2[l3]
                              + (
                                 (ai[l3] - (this.t.x[i3] - this.m.x - this.t.radx[i3])) * this.m.sin(this.t.xy[i3]) / this.m.sin(90 - this.t.xy[i3])
                                    - this.t.radx[i3] * this.m.sin(this.t.xy[i3]) / this.m.sin(90 - this.t.xy[i3])
                              )
                        );
                     }
                  }

                  i2 = (int)(this.t.c[i3][0] / 1.5);
                  j2 = (int)(this.t.c[i3][1] / 1.5);
                  k2 = (int)(this.t.c[i3][2] / 1.5);
                  break;
               }
            }
         }
         ...
         if (k1 == 2) {
            ...
            for (int i4 = 0; i4 < this.m.nsp; i4++) {
               for (int l4 = 0; l4 < this.n; l4++) {
                  if (Math.abs(ai[l4] - this.m.spx[i4]) < this.m.sprad[i4] && Math.abs(ai1[l4] - this.m.spz[i4]) < this.m.sprad[i4]) {
                     flag = false;
                  }
               }
            }
