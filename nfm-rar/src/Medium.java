...
public class Medium {
   ...
   public void lead(ContO conto, int i) {
      this.zy = 10;
      this.xz = -i;
      this.x = conto.x - this.cx + (int)(-(conto.z + 800 - conto.z) * this.sin(i));
      this.z = conto.z - this.cz + (int)((conto.z + 800 - conto.z) * this.cos(i));
   ...
   public void high(ContO conto, int i) {
      this.zy = 10;
      this.xz = -i;
      this.x = conto.x - this.cx + (int)(-(conto.z - 8000 - conto.z) * this.sin(i));
      this.z = conto.z - this.cz + (int)((conto.z - 8000 - conto.z) * this.cos(i));
      this.y = conto.y - 250 - this.cy;
      if (this.trns != 1) {
         this.trns = 1;
      }
